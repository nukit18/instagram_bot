...
async def like_share_function(login, password, hashtag, group_name, user_id):
...
async def close_browser_like_share():
    await close_browser()

if __name__ == '__main__':
    asyncio.run(like_share_function("login", "password", "hashtag", 0))  # тестовая функция
