...
async def share_save_function(login, password, hashtag, group_name, user_id):
...
async def close_browser_share_save():
    await close_browser()

if __name__ == '__main__':
    asyncio.run(share_save_function("login", "password", "hashtag", 0))  # тестовая функция
